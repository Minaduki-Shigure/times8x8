...
HD_PWD='C:/Users/wukan/Desktop/times/times.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log times.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source times.tcl
