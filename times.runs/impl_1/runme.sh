...
HD_PWD='C:/Users/wukan/Desktop/times/times.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log times.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source times.tcl -notrace
